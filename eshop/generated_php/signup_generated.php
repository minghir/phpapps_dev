...
class signup_generated extends template{
        public $form_com_type = "html"; // html | ajax
	public $globals;
	public $form_schema = "eshop";
	public $form_table = "clients";
        
	public $template;// = "gen_tpl/signup_generated.tpl";
        
        public $tpl = "signup_generated";
	...
	function check_errors(){
				...
				if($this->PASSWORD == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>PASSWORD</strong> este obligatoriu!");
		}
			}
