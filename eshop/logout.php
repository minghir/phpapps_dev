...
class logout_generated extends template{
     ...
     * @var string
     */
    protected $_SCRIPT_TITLE = "Admin logout";
     ...
     * @var string
     */
    protected $_SCRIPT_LABEL = "admin_logout";
    ...
    protected $display_objects_id = 363;
    ...
    function setup_display() {
        $this->globals->sm->assign(array("SCRIPT_CONTENT" => "logout: Youre code here."));
    }
    
}

new logout_generated();
?>