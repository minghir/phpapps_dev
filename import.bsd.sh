...
touch /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp.sql
cat /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp_start.sql >> /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp.sql
cat /usr/local/www/apache24/data/phpapps_dev/eshop/sql/eshop.sql >> /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp.sql
cat /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp_end.sql >> /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp.sql
mysql  -u root -palcatraz < /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp.sql
rm /usr/local/www/apache24/data/phpapps_dev/eshop/sql/imp.sql
