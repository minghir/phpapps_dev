...
cat /usr/local/www/apache24/data/phpapps_dev/phpapps/sql/imp_part.sql >> /usr/local/www/apache24/data/phpapps_dev/phpapps/sql/imp.sql
...
cat /usr/local/www/apache24/data/phpapps_dev/eshop_template/sql/imp_part.sql >> /usr/local/www/apache24/data/phpapps_dev/eshop_template/sql/imp.sql
...
cat /usr/local/www/apache24/data/phpapps_dev/atsepa/sql/imp_part.sql >> /usr/local/www/apache24/data/phpapps_dev/atsepa/sql/imp.sql
