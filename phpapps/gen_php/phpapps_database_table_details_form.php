...
class phpapps_database_table_details_form{
	...
	function setup_display(){
			...
			$this->FOREIGN_KEY_SCHEMA_ID_sel->setup_select_options();
									...
									$this->FOREIGN_KEY_TABLE_ID_sel = new DB_select("FOREIGN_KEY_TABLE_ID",".tables");
				$this->FOREIGN_KEY_TABLE_ID_sel->query = "SELECT ID AS VALUE, TABLE_NAME AS LABEL FROM .tables ORDER BY TABLE_NAME";
