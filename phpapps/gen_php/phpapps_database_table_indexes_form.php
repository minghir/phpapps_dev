...
class phpapps_database_table_indexes_form{
	public $globals;
	public $form_schema = "phpapps";
	public $form_table = "table_indexes";
	public $template = "gen_tpl/phpapps_database_table_indexes_form.tpl";
	//get values
	public $gact;
	public $gfield;
	public $gfield_value;
	...
	function __construct(){
		...
		$this->globals = &$GLOBALS_OBJ;
								...
								$this->INDEX_TYPE_sel = new DB_select("INDEX_TYPE",".list_index_types");
	...
	function getRec(){
		$sql = new DB_query( "SELECT 
			...
			$this->globals->con->next();
							...
							$this->INDEX_TYPE = stripslashes($this->globals->con->get_field("INDEX_TYPE"));
							$this->INDEX_COLUMNS = stripslashes($this->globals->con->get_field("INDEX_COLUMNS"));
	...
	function parsePostVars(){
		...
		$this->gfield_value = $_POST["gfield_value"];
					...
					$this->INDEX_TYPE  = addslashes(trim($_POST["INDEX_TYPE"]));
					$this->INDEX_COLUMNS  = addslashes(trim($_POST["INDEX_COLUMNS"]));
	...
	function check_errors(){
			...
			$this->errors[] = "Campul INDEX_NAME este obligatoriu!";
				...
				if($this->INDEX_TYPE == "") {
			$this->errors[] = "Campul INDEX_TYPE este obligatoriu!";
		}
	...
	function setup_display(){
								...
								//$this->INDEX_TYPE_sel = new DB_select("INDEX_TYPE",".list_index_types");
			$this->INDEX_TYPE_sel->selected_val = $this->INDEX_TYPE;
			$this->INDEX_TYPE_sel->setup_select_options();
		...
		$this->globals->sm->assign(array(
							...
							"DESCRIPTION" => $this->DESCRIPTION,
										...
										"INDEX_TYPE_sel" => $this->INDEX_TYPE_sel->get_select_str(),
