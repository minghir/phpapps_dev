...
class phpapps_designer_display_object_elements_form extends template{
	...
	function check_errors(){
				if($this->DISPLAY_OBJECT_ID == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>DISPLAY_OBJECT_ID</strong> este obligatoriu!");
		}
				if($this->DISPLAY_OBJECT_TYPE_ID == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>DISPLAY_OBJECT_TYPE_ID</strong> este obligatoriu!");
		}
				if($this->ELEMENT_ID == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>ELEMENT_ID</strong> este obligatoriu!");
		}
				if($this->ELEMENT_TYPE_ID == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>ELEMENT_TYPE_ID</strong> este obligatoriu!");
		}
				if($this->TEMPLATE_VARIABLE_NAME == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>TEMPLATE_VARIABLE_NAME</strong> este obligatoriu!");
		}
			}
