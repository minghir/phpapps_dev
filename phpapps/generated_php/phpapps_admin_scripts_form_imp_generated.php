...
class phpapps_admin_scripts_form_imp_generated extends template{
        public $form_com_type = "html"; // html | ajax
	public $globals;
	public $form_schema = "phpapps";
	public $form_table = "scripts";
        
	public $template;// = "gen_tpl/phpapps_admin_scripts_form_imp_generated.tpl";
        
        public $tpl = "phpapps_admin_scripts_form_imp_generated";
		...
		$this->query = new DB_query( "SELECT 
			...
			$this->globals->con->next();
			                                                                $this->ID = stripslashes($this->globals->con->get_field("ID"));
                                			                                                                ...
                                			                                                                $this->SCRIPT_TITLE = stripslashes($this->globals->con->get_field("SCRIPT_TITLE"));
                                			                                                                $this->SCRIPT_LABEL = stripslashes($this->globals->con->get_field("SCRIPT_LABEL"));
                                			                                                                $this->VERSION = stripslashes($this->globals->con->get_field("VERSION"));
	...
	function parse_post_vars(){
		...
		$this->gfield_value = $_POST["gfield_value"];
		                                                    ...
		                                                    $this->ID  = htmlspecialchars(addslashes(trim($_POST["ID"])));
                                                		                                                    ...
                                                		                                                    $this->SCRIPT_TITLE  = htmlspecialchars(addslashes(trim($_POST["SCRIPT_TITLE"])));
                                                		                                                    $this->SCRIPT_LABEL  = htmlspecialchars(addslashes(trim($_POST["SCRIPT_LABEL"])));
                                                		                                                    $this->VERSION  = htmlspecialchars(addslashes(trim($_POST["VERSION"])));
                                                		        }
