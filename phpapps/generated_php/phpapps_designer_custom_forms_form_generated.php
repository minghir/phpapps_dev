...
class phpapps_designer_custom_forms_form_generated extends template{
        public $form_com_type = "html"; // html | ajax
	public $globals;
	public $form_schema = "phpapps";
	public $form_table = "forms";
        
	public $template;// = "gen_tpl/phpapps_designer_custom_forms_form_generated.tpl";
        
        public $tpl = "phpapps_designer_custom_forms_form_generated";
		...
		$this->query = new DB_query( "SELECT 
			...
			$this->globals->con->next();
			                                                                $this->ID = stripslashes($this->globals->con->get_field("ID"));
                                			                                                                ...
                                			                                                                $this->FORM_TITLE = stripslashes($this->globals->con->get_field("FORM_TITLE"));
                                			                                                                $this->FORM_LABEL = stripslashes($this->globals->con->get_field("FORM_LABEL"));
                                			                                                                $this->FORM_TABLE = stripslashes($this->globals->con->get_field("FORM_TABLE"));
	...
	function parse_post_vars(){
		...
		$this->gfield_value = $_POST["gfield_value"];
		                                                    ...
		                                                    $this->ID  = htmlspecialchars(addslashes(trim($_POST["ID"])));
                                                		                                                    ...
                                                		                                                    $this->FORM_TITLE  = htmlspecialchars(addslashes(trim($_POST["FORM_TITLE"])));
                                                		                                                    $this->FORM_LABEL  = htmlspecialchars(addslashes(trim($_POST["FORM_LABEL"])));
                                                		                                                    $this->FORM_TABLE  = htmlspecialchars(addslashes(trim($_POST["FORM_TABLE"])));
	...
	function check_errors(){
				if($this->FORM_NAME == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>FORM_NAME</strong> este obligatoriu!");
		}
				if($this->FORM_TABLE == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>FORM_TABLE</strong> este obligatoriu!");
		}
			}
	...
	function setup_display(){
		...
		$this->smarty->assign(array(
							...
							"TEMPLATE_ID" => $this->TEMPLATE_ID,
										...
										"FORM_TABLE_sel" => $this->FORM_TABLE_sel->get_select_str(),
