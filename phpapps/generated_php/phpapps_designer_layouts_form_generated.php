...
class phpapps_designer_layouts_form_generated extends template{
        public $form_com_type = "html"; // html | ajax
	public $globals;
	public $form_schema = "phpapps";
	public $form_table = "layouts";
        
	public $template;// = "gen_tpl/phpapps_designer_layouts_form_generated.tpl";
        
        public $tpl = "phpapps_designer_layouts_form_generated";
	...
	function check_errors(){
				if($this->NAME == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>NAME</strong> este obligatoriu!");
		}
				if($this->APP_ID == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>APP_ID</strong> este obligatoriu!");
		}
				if($this->THEME_ID == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>THEME_ID</strong> este obligatoriu!");
		}
			}
