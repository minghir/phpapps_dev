...
class phpapps_designer_themes_form_generated extends template{
        public $form_com_type = "html"; // html | ajax
	public $globals;
	public $form_schema = "phpapps";
	public $form_table = "themes";
        
	public $template;// = "gen_tpl/phpapps_designer_themes_form_generated.tpl";
        
        public $tpl = "phpapps_designer_themes_form_generated";
	...
	function check_errors(){
				if($this->THEME_NAME == "") {
                        $this->alerts->add_alert("danger", "Campul <strong>THEME_NAME</strong> este obligatoriu!");
		}
				if($this->APP_ID == "") {
