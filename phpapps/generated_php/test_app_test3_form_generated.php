...
class test_app_test3_form_generated extends template{
        public $form_com_type = "html"; // html | ajax
	public $globals;
	public $form_schema = "phpapps";
	public $form_table = "test3";
        
	public $template;// = "gen_tpl/test_app_test3_form_generated.tpl";
        
        public $tpl = "test_app_test3_form_generated";
	...
	function setup_display(){
				...
				$this->COL1_sel->selected_val = $this->COL1;
				$this->COL1_sel->setup_select_options();
		...
		$this->smarty->assign(array(
							...
							"COL2" => $this->COL2,
										...
										"COL1_sel" => $this->COL1_sel->get_select_str(),
