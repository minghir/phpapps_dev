...
CREATE TABLE `applications` (
  ...
  CONSTRAINT `phpapps_applications_LAYOUT_ID_FK` FOREIGN KEY (`APPLICATION_TYPE_ID`) REFERENCES `layouts` (`ID`)
...
INSERT INTO `applications` VALUES (1,1,'phpapps','PHP Applications','3','.',1,'2016-03-13','Admin PHP Applications and more goodie lili si gp',1,1,'2020-04-22 15:07:10','0000-00-00 00:00:00'),(7,1,'eshop_template','E-Shop Template','7','..',1,'0000-00-00','',1,1,'2019-11-19 10:26:19','0000-00-00 00:00:00'),(8,1,'php_quiz','PHP Quiz','12','.',1,'2017-02-22','aa',1,1,'2019-11-19 10:26:19','2017-02-21 11:06:36'),(10,1,'atsepa','ATSEPA Romania','17','',1,'0000-00-00','',1,1,'2019-11-19 10:26:19','2017-07-09 08:31:09'),(87,1,'emanag','E-Management','19','',1,'2019-09-25','',1,1,'2019-11-19 10:26:19','2019-09-25 07:31:53'),(88,1,'cstudor','Clubul Sportiv Tudor','15','',1,'2019-11-30','',1,1,'2019-11-30 10:39:40','2019-11-30 10:39:40');
...
INSERT INTO `display_object_elements` VALUES (1,24,1,5,1,'PHPAPPS_MAIN_NAVBAR',''),(2,24,1,1,3,'PAGE_TITLE',''),(5,1,1,5,1,'PHPAPPS_MAIN_NAVBAR',''),(6,25,1,7,1,'meniu_laura',''),(7,253,2,3,1,'menu_2','adasd'),(8,253,2,1,4,'GRID_TEST_1',''),(9,174,2,2,4,'templates_grid',''),(10,174,2,3,4,'custom_elements_grid','');
...
INSERT INTO `grid_columns` VALUES (6,1,850,'','APP',''),(7,1,848,'\\\'MIMI\\\' AS FIFI','TEST2',''),(8,1,848,'\'MIMI\' AS FIFI','TEST2',''),(9,2,1078,'','TEMPLATE','run_code_editor.php?gact=editTpl'),(10,2,1080,'(SELECT VALUE FROM  phpapps.list_display_elements_types WHERE ID = ELEMENT_TYPE_ID ) AS ELEMENT_TYPE','TYPE',''),(11,2,1079,'( SELECT APP_NAME FROM phpapps.applications WHERE ID = APP_ID) AS APPLICATION','APPLICATION',''),(12,3,1127,'','ELEMENT NAME',''),(13,3,1128,'( SELECT APP_NAME FROM phpapps.applications WHERE ID = APP_ID) AS APPLICATION','APPLICATION','');
...
INSERT INTO `grids` VALUES (1,'GRID_TEST_1','GRID_TEST_1',1,338,0,0,0,0,0,177,20,2),(2,'PHPAPPS_DESIGNER_TEMPLATES_GRID','TEMPLATES',1,350,0,1,0,1,0,262,20,2),(3,'PHPAPPS_DESIGNER_CUSTOM_ELEMENTS_GRID','CUSTOM ELEMENTS',1,359,0,1,0,1,0,263,20,2);
...
INSERT INTO `layouts` VALUES (1,'phpapps',1,''),(5,'default',1,''),(19,'test_cpy_lay3',1,''),(20,'default2',1,''),(23,'phpapps_form',1,'test'),(24,'empty_layout',1,''),(25,'laura',1,'aaa'),(26,'phpapps_popup',1,''),(27,'phpapps_login',1,'');
...
INSERT INTO `list_databases` VALUES (1,'mysql','mysql'),(2,'test','test'),(3,'phpapps','phpapps'),(7,'eshop',''),(10,'information_schema',''),(11,'performance_schema',''),(12,'php_quiz',''),(15,'test',''),(16,'plan_perf',''),(17,'atsepa',''),(18,'romatsa_lol',''),(19,'emanag',''),(20,'recrutare',''),(21,'diomax','');
...
INSERT INTO `list_display_elements_types` VALUES (1,'','MENU'),(2,'','FORM'),(3,'','LAYOUT_VARIABLE'),(4,'','GRID');
...
INSERT INTO `list_display_objects_types` VALUES (1,'','LAYOUT'),(2,'','SCRIPT');
...
INSERT INTO `list_grid_types` VALUES (1,'','table'),(2,'','query');
...
--
-- Table structure for table `list_layout_elements_types`
--

DROP TABLE IF EXISTS `list_layout_elements_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `list_layout_elements_types` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `DESCRIPTION` text COLLATE utf8_bin DEFAULT NULL,
  `VALUE` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
...
--
-- Dumping data for table `list_layout_elements_types`
--

LOCK TABLES `list_layout_elements_types` WRITE;
/*!40000 ALTER TABLE `list_layout_elements_types` DISABLE KEYS */;
INSERT INTO `list_layout_elements_types` VALUES (1,'','MENU'),(2,'','FORM'),(3,'','LAYOUT_VARIABLE'),(4,'','GRID');
/*!40000 ALTER TABLE `list_layout_elements_types` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `menus` (
  ...
  `TEMPLATE_FILE` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT 'phpapps_default_menu',
  `DESCRIPTION` text COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
INSERT INTO `menus` VALUES (1,'TEST_MENU_1','TEST_MENU_1',2,1,5,'phpapps_default_menu',''),(3,'TEST_MENU_2','',2,2,11,'phpapps_default_menu',''),(4,'TEST_MENU_3','TEST_MENU_3',2,2,11,'phpapps_default_menu',''),(5,'PHPAPPS_MAIN_NAVBAR','WABCO',1,1,14,'phpapps_main_navbar',''),(6,'TEST_MENU_4','TEST_MENU_4',2,1,11,'phpapps_default_menu',''),(7,'laura','laura',2,2,11,'phpapps_default_menu','AAAA');
...
INSERT INTO `scripts` VALUES (47,1,'phpapps_admin_applications_form',2,'','.','.',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(54,10,'eshop_admin_categories_form',80,'','..\\eshop_template','..\\eshop_template',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(60,1,'phpapps_admin_scripts_form',83,'','.','.',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(65,1,'phpapps_admin_modules_form',3,'','.\\phpapps','.\\phpapps',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(66,7,'phpapps_users_roles_form',88,'','.','.',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(69,7,'phpapps_users_user_roles_form',90,'','.','.',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(72,7,'phpapps_users_permissions_form',89,'','.','.',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(76,7,'phpapps_users_role_permissions_form',91,'','.','.',1,1,5,'',1,1,'2020-04-05 17:18:16','0000-00-00 00:00:00'),(95,1,'phpapps_admin_forms_form',5,'','D:\\\\linuxport\\\\work\\','D:\\\\linuxport\\\\work\\',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-21 11:37:03'),(100,14,'phpapps_database_list_form',210,'','D:\\\\linuxport\\\\work\\','D:\\\\linuxport\\\\work\\',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-21 14:57:13'),(101,14,'phpapps_database_mysql_column_defs_form',222,'','/var/www/html/phpapp','/var/www/html/phpapp',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-24 05:10:00'),(103,14,'phpapps_database_sql_sintax_form',224,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-26 06:31:40'),(105,14,'phpapps_database_lists_form',197,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-27 09:52:59'),(107,14,'phpapps_database_tables_form',197,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-28 08:58:39'),(114,14,'phpapps_database_table_details_form',198,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-30 08:29:05'),(115,14,'phpapps_database_table_details_DDL_form',198,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-09-30 08:33:22'),(117,14,'phpapps_database_table_fks_DDL_form',276,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-10-03 07:46:58'),(118,14,'phpapps_database_table_indexes_form',279,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-10-03 10:53:46'),(119,14,'phpapps_database_table_indexes_DDL_form',279,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-10-03 12:02:10'),(120,14,'phpapps_database_add_table_form',197,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2016-10-11 09:04:57'),(125,15,'php_quiz_questions_questions_form',284,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-02-27 08:06:39'),(127,14,'phpapps_database_list_databases_form',199,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-04-27 05:10:50'),(132,14,'phpapps_database_queries_form',281,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-09-20 08:30:22'),(134,18,'imp_exp_test_import_form',298,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-09-22 06:16:12'),(135,20,'admin_app_users_form',299,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-09-25 07:11:35'),(139,19,'articles_app_users_form',294,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-09-25 09:57:04'),(140,19,'articles_articles_form',292,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-09-25 12:46:40'),(142,17,'forum_forum_categories_form',301,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-10-02 12:14:27'),(143,17,'forum_topics_form',302,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-10-02 13:15:21'),(144,17,'forum_posts_form',304,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-10-02 13:20:38'),(145,20,'admin_contact_form',305,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2017-10-11 08:29:40'),(147,26,'emanag_lol_lol_vars_form',314,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-10-01 10:10:49'),(148,1,'phpapps_admin_test_upload_form',318,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-10-28 08:32:34'),(149,26,'emanag_lol_personal_form',315,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-10-28 13:15:47'),(150,26,'emanag_lol_loc_munca_form',322,'','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-10-29 09:08:27'),(151,21,'phpapps_designer_themes_form',324,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-09 11:12:22'),(153,7,'phpapps_users_user_profiles_form',99,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-09 15:45:50'),(154,1,'phpapps_admin_module',0,'',NULL,NULL,2,1,1,'',1,1,'2020-04-21 09:56:22','2019-11-20 08:24:00'),(155,7,'phpapps_users_module',0,'',NULL,NULL,2,1,1,'',1,1,'2020-04-21 10:02:41','2019-11-20 08:24:00'),(156,7,'phpapps_users_generate_permissions',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(157,7,'phpapps_users_manage_user_roles',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(158,14,'sql_console',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(159,1,'index',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(160,7,'phpapps_users_manage_roles_permissions',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(161,1,'phpapps_login',0,'',NULL,NULL,2,2,27,'',1,1,'2020-04-23 16:58:21','2019-11-20 08:24:00'),(162,7,'user_home',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(163,1,'phpapps_admin_applications',0,'',NULL,NULL,2,1,1,'',1,1,'2020-04-21 10:04:11','2019-11-20 08:24:00'),(164,1,'phpinfo',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(165,14,'phpapps_database_module',0,'',NULL,NULL,2,1,1,'',1,1,'2020-04-21 09:58:17','2019-11-20 08:24:00'),(166,14,'phpapps_database_browse_list',0,'',NULL,NULL,2,1,26,'',1,1,'2020-04-22 06:37:40','2019-11-20 08:24:00'),(167,14,'test_column_def',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(168,14,'phpapps_database_browse_tables',0,'',NULL,NULL,2,1,26,'',1,1,'2020-04-22 06:38:53','2019-11-20 08:24:00'),(169,15,'questions',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(170,15,'quiz_test',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(171,18,'import_excel',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(172,19,'articles',0,'',NULL,NULL,2,2,5,'display articles grid',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(173,21,'layout_designer',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(174,21,'phpapps_designer_module',0,'',NULL,NULL,2,1,1,'',1,1,'2020-04-21 10:01:02','2019-11-20 08:24:00'),(175,17,'forum_categs',0,'',NULL,NULL,2,2,5,'Display forum categories',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(176,19,'article',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(177,19,'about',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(178,20,'login',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(179,17,'forum_topics',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(180,17,'forum_posts',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(181,20,'contact',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(182,20,'sign_up',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(183,20,'home',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(184,14,'phpapps_database_table_rescan_columns',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(185,14,'phpapps_database_table_rescan_indexes',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(186,14,'phpapps_database_table_rescan_FKs',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(187,1,'test_jquery',0,'',NULL,NULL,2,2,5,'special pentru atesta jquery',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(188,1,'test_oci',0,'',NULL,NULL,2,1,5,'TEST EMANAG',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(189,14,'user_profile',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(190,26,'populate_personal',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(191,26,'test_img',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-20 08:24:00'),(192,21,'scr_test_menu',0,'',NULL,NULL,2,1,24,'',1,1,'2020-04-21 07:58:05','2019-11-20 08:24:00'),(193,21,'scr_test_layout',0,'',NULL,NULL,2,1,20,'',1,1,'2020-04-05 19:20:50','2019-11-20 08:24:00'),(230,7,'phpapps_login',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-22 18:02:33'),(231,27,'phpapps_test3_get_php',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-23 08:21:26'),(232,27,'phpapps_test_app_test1_form',335,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-23 08:32:13'),(233,27,'phpapps_test_app_test2_form',336,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,'',1,1,'2020-04-05 17:18:16','2019-11-23 12:27:28'),(234,29,'cstudor_contact',0,'',NULL,NULL,2,2,5,'',1,1,'2020-04-05 17:18:16','2019-11-30 10:41:36'),(238,21,'phpapps_designer_menu_run',0,'',NULL,NULL,2,1,26,'',1,1,'2020-04-22 07:34:17','2020-04-17 07:49:38'),(240,21,'phpapps_designer_menus_form',328,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-17 08:35:11','2020-04-17 08:35:11'),(241,21,'phpapps_designer_menu_items_form',331,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-17 09:44:23','2020-04-17 09:44:23'),(242,14,'phpapps_database_views_form',202,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-18 08:41:57','2020-04-18 08:41:57'),(243,14,'phpapps_database_query_parameters_form',341,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-18 09:18:40','2020-04-18 09:18:40'),(244,21,'phpapps_designer_layout_variables_form',346,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-20 09:39:50','2020-04-20 09:39:50'),(245,21,'phpapps_designer_layout_elements_form',343,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-20 10:01:55','2020-04-20 10:01:55'),(247,10,'index',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-20 18:23:50','2020-04-20 18:23:50'),(248,1,'phpapps',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-21 06:38:03','2020-04-21 06:38:03'),(249,10,'eshop_template',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-21 06:39:24','2020-04-21 06:39:24'),(250,10,'php_quiz',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-21 06:40:00','2020-04-21 06:40:00'),(251,20,'atsepa',0,'',NULL,NULL,2,1,5,'',1,1,'2020-04-21 06:40:27','2020-04-21 06:40:27'),(252,8,'phpapps_languages_module',0,'',NULL,NULL,2,1,1,'',1,1,'2020-04-21 16:23:57','2020-04-21 16:23:57'),(253,21,'test_laura',0,'',NULL,NULL,2,1,25,'',1,1,'2020-04-22 20:11:41','2020-04-21 19:48:24'),(254,14,'phpapps_database_browse_views',0,'',NULL,NULL,2,1,26,'',1,1,'2020-04-22 06:42:49','2020-04-22 06:42:49'),(255,14,'phpapps_database_browse_queries',0,'',NULL,NULL,2,1,26,'',1,1,'2020-04-22 06:43:46','2020-04-22 06:43:46'),(256,21,'phpapps_designer_grids_form',347,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-22 06:56:27','2020-04-22 06:56:27'),(257,21,'phpapps_designer_layout_elements_templates_form',350,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-22 07:38:59','2020-04-22 07:38:59'),(258,21,'phpapps_designer_grid_run',0,'',NULL,NULL,2,1,26,'',1,1,'2020-04-22 08:40:33','2020-04-22 08:40:33'),(259,21,'phpapps_designer_grid_columns_form',351,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,'',1,1,'2020-04-22 19:54:22','2020-04-22 11:28:10'),(260,21,'phpapps_designer_display_object_elements_form',343,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-22 16:28:41','2020-04-22 16:28:41'),(261,21,'phpapps_designer_layouts_form',300,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-22 18:43:47','2020-04-22 18:43:47'),(262,21,'phpapps_designer_templates_form',350,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-23 09:25:20','2020-04-23 09:25:20'),(263,21,'phpapps_designer_custom_elements_form',359,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-23 10:52:32','2020-04-23 10:52:32'),(264,7,'phpapps_users_users_form',87,'','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,'',1,1,'2020-04-23 18:16:38','2020-04-23 18:16:38');
...
CREATE TABLE `templates` (
  ...
  KEY `phpapps_layout_elements_templates_ELEMENT_TYPE_ID_FK` (`ELEMENT_TYPE_ID`),
  CONSTRAINT `phpapps_layout_elements_templates_ELEMENT_TYPE_ID_FK` FOREIGN KEY (`ELEMENT_TYPE_ID`) REFERENCES `list_layout_elements_types` (`ID`)
...
INSERT INTO `templates` VALUES (1,'default',1,'',4),(2,'db_grid4',1,NULL,4),(20,'test_1',7,'',1);
...
/*!50001 CREATE TABLE `view_menus` (
  `TEMPLATE_FILE` tinyint NOT NULL,
  `ID` tinyint NOT NULL,
  `NAME` tinyint NOT NULL,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_menus` AS select `m`.`TEMPLATE_FILE` AS `TEMPLATE_FILE`,`m`.`ID` AS `ID`,`m`.`NAME` AS `NAME`,`m`.`MENU_TITLE` AS `MENU_TITLE`,`m`.`DESCRIPTION` AS `DESCRIPTION`,`lmt`.`VALUE` AS `MENU_TYPE`,`lmt`.`ID` AS `LIST_MENU_TYPE_ID`,`lmo`.`VALUE` AS `ORIENTATION`,`lmo`.`ID` AS `LIST_MENU_ORIENTATION_ID`,`m`.`QUERY_ID` AS `QUERY_ID`,`q`.`QUERY_NAME` AS `QUERY_NAME`,`q`.`DESCRIPTION` AS `QUERY_DESCRIPTION`,`q`.`QUERY_BODY` AS `QUERY_BODY` from (((`menus` `m` join `list_menu_types` `lmt`) join `list_menu_orientation` `lmo`) join `queries` `q`) where `m`.`MENU_TYPE` = `lmt`.`ID` and `m`.`ORIENTATION` = `lmo`.`ID` and `m`.`QUERY_ID` = `q`.`ID` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_templates` AS select `t`.`ID` AS `ID`,`t`.`TEMPLATE_NAME` AS `TEMPLATE_NAME`,`t`.`APP_ID` AS `APP_ID`,`a`.`APP_NAME` AS `APP_NAME`,`t`.`DESCRIPTION` AS `DESCRIPTION`,`t`.`ELEMENT_TYPE_ID` AS `ELEMENT_TYPE_ID`,(select `ldet`.`VALUE` from `list_display_elements_types` `ldet` where `t`.`ELEMENT_TYPE_ID` = `ldet`.`ID`) AS `ELEMENT_TYPE` from (`templates` `t` left join `applications` `a` on(`a`.`ID` = `t`.`APP_ID`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-04-25 10:43:34
