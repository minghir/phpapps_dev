...
CREATE TABLE `layout_elements` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `LAYOUT_ID` bigint(255) DEFAULT NULL,
  `ELEMENT_ID` bigint(20) DEFAULT NULL,
  `ELEMENT_TYPE` bigint(20) DEFAULT NULL,
  `LAYOUT_VARIABLE_NAME` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `DESCRIPTION` text COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `phpapps_layout_elements_LAYOUT_ID_FK` (`LAYOUT_ID`),
  KEY `phpapps_layout_elements_ELEMENT_TYPE_FK` (`ELEMENT_TYPE`),
  CONSTRAINT `phpapps_layout_elements_ELEMENT_TYPE_FK` FOREIGN KEY (`ELEMENT_TYPE`) REFERENCES `list_layout_elements_types` (`ID`),
  CONSTRAINT `phpapps_layout_elements_LAYOUT_ID_FK` FOREIGN KEY (`LAYOUT_ID`) REFERENCES `layouts` (`ID`)
...
LOCK TABLES `layout_elements` WRITE;
/*!40000 ALTER TABLE `layout_elements` DISABLE KEYS */;
INSERT INTO `layout_elements` VALUES (1,24,5,1,'PHPAPPS_MAIN_NAVBAR',''),(2,24,1,3,'PAGE_TITLE',''),(5,1,5,1,'PHPAPPS_MAIN_NAVBAR','');
/*!40000 ALTER TABLE `layout_elements` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `layouts` VALUES (1,'phpapps',1,''),(3,'test1',1,''),(4,'test2',1,''),(5,'default',1,''),(19,'test_cpy_lay3',1,''),(20,'default2',1,''),(23,'phpapps_form',1,'test'),(24,'empty_layout',1,'');
...
INSERT INTO `list_layout_elements_types` VALUES (1,'','MENU'),(2,'','FORM'),(3,'','LAYOUT_VARIABLE');
...
INSERT INTO `list_menu_types` VALUES (1,'','DINAMIC'),(2,'','STATIC');
...
INSERT INTO `menu_items` VALUES (3,0,3,'test1.php?aa=bb&amp;cc=dd','TEST1'),(4,3,3,'http://www.google.com','TEST2'),(5,4,3,'AA2','AA'),(6,0,4,'AA2','TEST1ss'),(7,0,4,'AA2','TEST3ssss'),(8,0,3,'MENU2','MENU2'),(9,8,3,'SUB_1_MENU2','SUB_1_MENU2'),(10,8,3,'SUB_2_MENU2','SUB_2_MENU2'),(11,9,3,'SUB_SUB_1_MENU2','SUB_SUB_1_MENU2'),(12,0,6,'TEST_M4','TEST_M4');
...
INSERT INTO `menus` VALUES (1,'TEST_MENU_1','TEST_MENU_1',2,1,5,'phpapps_default_menu',''),(3,'TEST_MENU_2','',2,2,11,'phpapps_default_menu',''),(4,'TEST_MENU_3','TEST_MENU_3',2,2,11,'phpapps_default_menu',''),(5,'PHPAPPS_MAIN_NAVBAR','WABCO',1,1,14,'phpapps_main_navbar',''),(6,'TEST_MENU_4','TEST_MENU_4',2,1,11,'phpapps_default_menu','');
...
--
-- Temporary table structure for view `view_posible_layout_elements`
--

DROP TABLE IF EXISTS `view_posible_layout_elements`;
/*!50001 DROP VIEW IF EXISTS `view_posible_layout_elements`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `view_posible_layout_elements` (
  `ID` tinyint NOT NULL,
...
--
-- Final view structure for view `view_posible_layout_elements`
--

/*!50001 DROP TABLE IF EXISTS `view_posible_layout_elements`*/;
/*!50001 DROP VIEW IF EXISTS `view_posible_layout_elements`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_posible_layout_elements` AS select `menus`.`ID` AS `ID`,concat(`menus`.`NAME`,'(menu)') AS `ELEMENT_NAME`,'1' AS `ELEMENT_TYPE` from `menus` union all select `scripts`.`ID` AS `ID`,concat(`scripts`.`SCRIPT_NAME`,'(form)') AS `ELEMENT_NAME`,'2' AS `ELEMENT_TYPE` from `scripts` where `scripts`.`WEB_TYPE_ID` = '1' union all select `layout_variables`.`ID` AS `ID`,concat(`layout_variables`.`VARIABLE_NAME`,'(layout variable)') AS `ELEMENT_NAME`,'3' AS `ELEMENT_TYPE` from `layout_variables` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-04-21 21:46:16
