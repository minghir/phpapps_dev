...
INSERT INTO `list_layout_elements_types` VALUES (1,'','MENU'),(2,'','FORM');
...
INSERT INTO `query_parameters` VALUES (4,6,':id','10',1),(5,11,':MENU_ID','$MENU_ID',2),(6,6,':id2','14',1);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_posible_layout_elements` AS select `menus`.`ID` AS `ID`,`menus`.`NAME` AS `VALUE`,'1' AS `ELEMENT_TYPE` from `menus` union all select `scripts`.`ID` AS `ID`,`scripts`.`SCRIPT_NAME` AS `VALUE`,'2' AS `ELEMENT_TYPE` from `scripts` where `scripts`.`WEB_TYPE_ID` = '1' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-04-20 12:11:19
