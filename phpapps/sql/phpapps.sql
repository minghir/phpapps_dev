...
INSERT INTO `display_object_elements` VALUES (1,24,1,5,1,'PHPAPPS_MAIN_NAVBAR',''),(2,24,1,1,3,'PAGE_TITLE',''),(5,1,1,5,1,'PHPAPPS_MAIN_NAVBAR',''),(6,25,1,7,1,'meniu_laura',''),(7,253,2,3,1,'menu_2','adasd'),(8,253,2,1,4,'GRID_TEST_1','');
...
INSERT INTO `grid_columns` VALUES (6,1,850,'','APP',''),(7,1,848,'\\\'MIMI\\\' AS FIFI','TEST2',''),(8,1,848,'\'MIMI\' AS FIFI','TEST2','');
...
INSERT INTO `grids` VALUES (1,'GRID_TEST_1','GRID_TEST_1',1,338,0,0,0,0,0,177,20,2),(2,'TEMPLATES','TEMPLATES',1,350,0,0,0,1,0,0,20,2);
...
INSERT INTO `layouts` VALUES (1,'phpapps',1,''),(3,'test1',1,''),(4,'test2',1,''),(5,'default',1,''),(19,'test_cpy_lay3',1,''),(20,'default2',1,''),(23,'phpapps_form',1,'test'),(24,'empty_layout',1,''),(25,'laura',1,'aaa'),(26,'phpapps_popup',1,'');
...
INSERT INTO `templates` VALUES (1,'GRID_DEFAULT_TEMPLATE',1,NULL,4),(2,'db_grid4',1,NULL,4);
...
/*!50001 CREATE TABLE `view_grids` (
  ...
  `EDIT_FORM_RUN_PATH` tinyint NOT NULL,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_grids` AS select `g`.`ID` AS `ID`,`g`.`GRID_NAME` AS `GRID_NAME`,`g`.`GRID_TITLE` AS `GRID_TITLE`,`g`.`GRID_TYPE` AS `GRID_TYPE_ID`,(select `lgt`.`VALUE` from `list_grid_types` `lgt` where `lgt`.`ID` = `g`.`GRID_TYPE`) AS `GRID_TYPE`,`g`.`TABLE_ID` AS `TABLE_ID`,`g`.`QUERY_ID` AS `QUERY_ID`,`g`.`EDITABLE` AS `EDITABLE`,`g`.`FILTERABLE` AS `FILTERABLE`,`g`.`PAGINABLE` AS `PAGINABLE`,`g`.`EXPORTABLE` AS `EXPORTABLE`,`g`.`EDIT_FORM_ID` AS `EDIT_FORM_ID`,`g`.`ROWS_ON_PAGE` AS `ROWS_ON_PAGE`,`g`.`ELEMENT_TEMPLATE_ID` AS `ELEMENT_TEMPLATE_ID`,`s`.`RUN_PATH` AS `EDIT_FORM_RUN_PATH`,`s`.`FILE_NAME` AS `EDIT_FORM_FILE_NAME`,concat(`t`.`TABLE_SCHEMA`,'.',`t`.`TABLE_NAME`) AS `TABLE_NAME` from ((`grids` `g` left join `view_scripts` `s` on(`s`.`ID` = `g`.`EDIT_FORM_ID`)) left join `view_tables` `t` on(`g`.`TABLE_ID` = `t`.`ID`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
