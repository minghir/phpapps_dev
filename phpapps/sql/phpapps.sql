...
INSERT INTO `applications` VALUES (1,1,'phpapps','PHP Applications',NULL,'3','.',1,'2016-03-13','Admin PHP Applications and more goodie lili si gp',1,1,'2020-04-22 15:07:10','0000-00-00 00:00:00'),(7,1,'eshop','E-Shop',NULL,'7','..',2,'0000-00-00','',1,1,'2020-04-29 18:36:47','0000-00-00 00:00:00'),(8,1,'php_quiz','PHP Quiz',NULL,'12','.',1,'2017-02-22','aa',1,1,'2019-11-19 10:26:19','2017-02-21 11:06:36'),(10,1,'atsepa','ATSEPA Romania',NULL,'17','',1,'0000-00-00','',1,1,'2019-11-19 10:26:19','2017-07-09 08:31:09'),(88,1,'cstudor','Clubul Sportiv Tudor',NULL,'15','',1,'2019-11-30','',1,1,'2019-11-30 10:39:40','2019-11-30 10:39:40');
...
INSERT INTO `custom_elements` VALUES (14,'CUSTOM_ELEMENT_1',1,'',NULL,33),(27,'CUSTOM_ELEMENT_2',1,'',NULL,33),(28,'TEMPLATE_SOURCE_EDITOR',1,'',NULL,33),(29,'PHP_SOURCE_EDITOR',1,'',NULL,2),(33,'CUSTOM_ELEMENT_3',1,'',NULL,33),(37,'CUSTOM_ELEMENT_4',1,'',NULL,0),(38,'CUSTOM_ELEMENT_5',1,'',NULL,0),(39,'CUSTOM_ELEMENT_6',1,'fff',NULL,0);
...
CREATE TABLE `forms` (
  ...
  `FORM_TITLE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `FORM_LABEL` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `FORM_TABLE` bigint(20) DEFAULT NULL,
  `DESCRIPTION` text COLLATE utf8_bin DEFAULT NULL,
  `TEMPLATE_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `phpapps_forms_FORM_TABLE_FK` (`FORM_TABLE`),
  CONSTRAINT `phpapps_forms_FORM_TABLE_FK` FOREIGN KEY (`FORM_TABLE`) REFERENCES `tables` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `list_script_versions`
--

DROP TABLE IF EXISTS `list_script_versions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `list_script_versions` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `DESCRIPTION` text COLLATE utf8_bin DEFAULT NULL,
  `VALUE` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
...
--
-- Dumping data for table `list_script_versions`
--

LOCK TABLES `list_script_versions` WRITE;
/*!40000 ALTER TABLE `list_script_versions` DISABLE KEYS */;
INSERT INTO `list_script_versions` VALUES (1,'0.001','SCRIPT_VER'),(2,'0.001','SCRIPT_FORM_VER');
/*!40000 ALTER TABLE `list_script_versions` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `menus` VALUES (3,'TEST_MENU_2','',2,2,11,38,''),(4,'TEST_MENU_3','TEST_MENU_3',2,2,11,38,''),(5,'PHPAPPS_MAIN_NAVBAR','WABDO',1,1,14,38,''),(6,'TEST_MENU_4','TEST_MENU_4',2,1,11,38,''),(7,'laura','laura',2,2,11,20,'AAAA');
...
INSERT INTO `modules` VALUES (1,1,154,'phpapps_admin','admin',NULL,'0000-00-00','',1,1,'2020-04-21 15:39:30','0000-00-00 00:00:00'),(7,1,155,'phpapps_users','users',NULL,'0000-00-00','aaa',1,1,'2020-05-13 08:54:41','0000-00-00 00:00:00'),(8,1,252,'phpapps_lang','languages',NULL,'0000-00-00','',1,1,'2020-04-21 16:24:39','0000-00-00 00:00:00'),(10,7,299,'eshop_admin','admin',NULL,'0000-00-00','',1,1,'2020-05-01 08:01:48','0000-00-00 00:00:00'),(14,1,165,'phpapps_database','database',NULL,'2016-09-21','',1,1,'2020-04-21 15:39:54','2016-09-21 07:01:06'),(15,8,154,'questions','Questions',NULL,'2017-02-21','',1,1,'2019-11-20 09:53:12','2017-02-21 12:12:54'),(17,10,154,'forum','Forum',NULL,'2017-07-09','',1,1,'2019-11-20 09:53:12','2017-07-09 08:33:48'),(18,1,154,'imp_exp','import / export',NULL,'2017-07-09','',1,1,'2020-04-21 15:40:12','2017-07-09 09:27:25'),(19,10,154,'articles','Articles',NULL,'2017-07-09','',1,1,'2019-11-20 09:53:12','2017-07-09 11:26:27'),(20,10,154,'admin','Admin',NULL,'2017-07-09','',1,1,'2019-11-20 09:53:12','2017-07-09 12:24:29'),(21,1,174,'phpapps_designer','designer',NULL,'2017-09-28','',1,1,'2020-04-21 15:40:18','2017-09-28 06:25:31'),(27,1,154,'test_app','tests',NULL,'2019-11-20','',1,1,'2020-04-21 15:40:36','2019-11-20 13:23:49'),(29,88,154,'cstudor_admin','Admin',NULL,'2019-11-30','Administration page',1,1,'2019-11-30 10:40:49','2019-11-30 10:40:49'),(31,7,291,'eshop_public','public',NULL,'2020-04-25','',1,1,'2020-04-29 18:46:18','2020-04-25 11:49:22');
...
CREATE TABLE `scripts` (
  ...
  `SCRIPT_LABEL` varchar(255) DEFAULT NULL,
...
INSERT INTO `scripts` VALUES (60,1,'phpapps_admin_scripts_form_imp',83,'stitle','slabel','.','.',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','0000-00-00 00:00:00'),(65,1,'phpapps_admin_modules_form_imp',3,'stitle','slabel','.\\phpapps','.\\phpapps',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','0000-00-00 00:00:00'),(66,7,'phpapps_users_roles_form_imp',88,'stitle','slabel','.','.',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','0000-00-00 00:00:00'),(69,7,'phpapps_users_user_roles_form_imp',90,'stitle','slabel','.','.',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','0000-00-00 00:00:00'),(72,7,'phpapps_users_permissions_form_imp',89,'stitle','slabel','.','.',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','0000-00-00 00:00:00'),(76,7,'phpapps_users_role_permissions_form_imp',91,'stitle','slabel','.','.',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','0000-00-00 00:00:00'),(95,1,'phpapps_admin_forms_form_imp',5,'stitle','slabel','D:\\\\linuxport\\\\work\\','D:\\\\linuxport\\\\work\\',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-21 11:37:03'),(101,14,'phpapps_database_mysql_column_defs_form_imp',222,'stitle','slabel','/var/www/html/phpapp','/var/www/html/phpapp',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-24 05:10:00'),(103,14,'phpapps_database_sql_sintax_form_imp',224,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-26 06:31:40'),(105,14,'phpapps_database_lists_form_imp',197,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-27 09:52:59'),(107,14,'phpapps_database_tables_form_imp',197,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-28 08:58:39'),(114,14,'phpapps_database_table_details_form_imp',198,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-30 08:29:05'),(115,14,'phpapps_database_table_details_DDL_form_imp',198,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-09-30 08:33:22'),(117,14,'phpapps_database_table_fks_DDL_form_imp',276,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-10-03 07:46:58'),(118,14,'phpapps_database_table_indexes_form_imp',279,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-10-03 10:53:46'),(119,14,'phpapps_database_table_indexes_DDL_form_imp',279,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-10-03 12:02:10'),(120,14,'phpapps_database_add_table_form_imp',197,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2016-10-11 09:04:57'),(125,15,'php_quiz_questions_questions_form_imp',284,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-02-27 08:06:39'),(132,14,'phpapps_database_queries_form_imp',281,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-09-20 08:30:22'),(134,18,'imp_exp_test_import_form_imp',298,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-09-22 06:16:12'),(135,20,'admin_app_users_form_imp',299,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-09-25 07:11:35'),(139,19,'articles_app_users_form_imp',294,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-09-25 09:57:04'),(140,19,'articles_articles_form_imp',292,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-09-25 12:46:40'),(142,17,'forum_forum_categories_form_imp',301,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-10-02 12:14:27'),(143,17,'forum_topics_form_imp',302,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-10-02 13:15:21'),(144,17,'forum_posts_form_imp',304,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-10-02 13:20:38'),(145,20,'admin_contact_form_imp',305,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2017-10-11 08:29:40'),(148,1,'phpapps_admin_test_upload_form_imp',318,'stitle','slabel','D:/linuxport/work/ww','D:/linuxport/work/ww',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2019-10-28 08:32:34'),(151,21,'phpapps_designer_themes_form_imp',324,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2019-11-09 11:12:22'),(153,7,'phpapps_users_user_profiles_form_imp',99,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2019-11-09 15:45:50'),(154,1,'phpapps_admin_module',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(155,7,'phpapps_users_module',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(156,7,'phpapps_users_generate_permissions',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(157,7,'phpapps_users_manage_user_roles',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(158,14,'sql_console',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(159,1,'index',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(160,7,'phpapps_users_manage_roles_permissions',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(161,1,'phpapps_login',0,'stitle','slabel',NULL,NULL,2,2,27,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(162,7,'user_home',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(163,1,'phpapps_admin_applications',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(164,1,'phpinfo',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(165,14,'phpapps_database_module',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(166,14,'phpapps_database_browse_list',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(167,14,'test_column_def',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(168,14,'phpapps_database_browse_tables',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(169,15,'questions',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(170,15,'quiz_test',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(171,18,'import_excel',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(172,19,'articles',0,'stitle','slabel',NULL,NULL,2,2,5,0,'display articles grid',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(173,21,'layout_designer',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(174,21,'phpapps_designer_module',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(175,17,'forum_categs',0,'stitle','slabel',NULL,NULL,2,2,5,0,'Display forum categories',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(176,19,'article',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(177,19,'about',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(178,20,'login',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(179,17,'forum_topics',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(180,17,'forum_posts',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(181,20,'contact',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(182,20,'sign_up',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(183,20,'home',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(184,14,'phpapps_database_table_rescan_columns',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(185,14,'phpapps_database_table_rescan_indexes',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(186,14,'phpapps_database_table_rescan_FKs',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(187,1,'test_jquery',0,'stitle','slabel',NULL,NULL,2,2,5,0,'special pentru atesta jquery',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(188,1,'test_oci',0,'stitle','slabel',NULL,NULL,2,1,5,0,'TEST EMANAG',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(189,14,'user_profile',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-20 08:24:00'),(230,7,'phpapps_login',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-22 18:02:33'),(234,29,'cstudor_contact',0,'stitle','slabel',NULL,NULL,2,2,5,0,'',0,1,1,'2020-05-09 07:30:42','2019-11-30 10:41:36'),(238,21,'phpapps_designer_menu_run',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-17 07:49:38'),(240,21,'phpapps_designer_menus_form_imp',328,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-17 08:35:11'),(241,21,'phpapps_designer_menu_items_form_imp',331,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-17 09:44:23'),(242,14,'phpapps_database_views_form_imp',202,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-18 08:41:57'),(243,14,'phpapps_database_query_parameters_form_imp',341,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-18 09:18:40'),(244,21,'phpapps_designer_layout_variables_form_imp',346,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-20 09:39:50'),(245,21,'phpapps_designer_layout_elements_form_imp',343,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-20 10:01:55'),(247,10,'index',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-20 18:23:50'),(248,1,'phpapps',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-21 06:38:03'),(251,20,'atsepa',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-21 06:40:27'),(252,8,'phpapps_languages_module',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-21 16:23:57'),(253,21,'test_laura',0,'stitle','slabel',NULL,NULL,2,1,25,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-21 19:48:24'),(254,14,'phpapps_database_browse_views',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-22 06:42:49'),(255,14,'phpapps_database_browse_queries',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-22 06:43:46'),(256,21,'phpapps_designer_grids_form_imp',347,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-22 06:56:27'),(257,21,'phpapps_designer_layout_elements_templates_form_imp',350,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-22 07:38:59'),(258,21,'phpapps_designer_grid_run',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-22 08:40:33'),(259,21,'phpapps_designer_grid_columns_form_imp',351,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-22 11:28:10'),(260,21,'phpapps_designer_display_object_elements_form_imp',343,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-22 16:28:41'),(261,21,'phpapps_designer_layouts_form_imp',300,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-22 18:43:47'),(263,21,'phpapps_designer_custom_elements_form_imp',359,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-23 10:52:32'),(264,7,'phpapps_users_users_form_imp',87,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-23 18:16:38'),(265,21,'phpapps_designer_custom_element_run',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-25 12:35:17'),(268,21,'test_victor',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-26 06:49:50'),(274,21,'phpapps_designer_templates_form_imp',350,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-26 08:02:22'),(278,21,'phpapps_designer_forms_form_imp',360,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,5,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-26 10:34:08'),(281,21,'test_victor2',0,'stitle','slabel',NULL,NULL,2,1,5,34,'',0,1,1,'2020-05-09 07:30:42','2020-04-26 10:42:37'),(283,1,'run_php_script',0,'stitle','slabel',NULL,NULL,2,1,26,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-26 14:12:12'),(285,21,'phpapps_designer_grid_actions_form_imp',363,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-26 17:10:16'),(286,27,'aa',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-26 20:56:08'),(287,27,'bb',0,'stitle','slabel',NULL,NULL,2,1,5,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-26 21:22:01'),(288,1,'phpapps_admin_applications_form',2,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:04:48','2020-04-29 07:23:54'),(289,14,'phpapps_database_list_databases_form_imp',199,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,26,0,'',0,1,1,'2020-05-09 09:01:01','2020-04-29 08:43:02'),(291,1,'phpapps_admin_module_default',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-04-29 18:17:35'),(294,14,'phpapps_database_list_form_imp',210,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-05-01 06:44:43'),(298,10,'eshop_admin_categories_form_imp',80,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\eshop','D:/work/www\\\\phpapps_dev\\\\eshop',1,1,31,0,'',0,1,1,'2020-05-09 09:01:01','2020-05-01 07:48:14'),(299,10,'eshop_admin_module',0,'stitle','slabel',NULL,NULL,2,1,31,0,'',0,1,1,'2020-05-09 07:30:42','2020-05-01 08:01:09'),(300,1,'phpapps_admin_other_module',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-05-01 09:23:33'),(301,10,'eshop_admin_products_form_imp',377,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\eshop','D:/work/www\\\\phpapps_dev\\\\eshop',1,1,31,0,'',0,1,1,'2020-05-09 09:01:01','2020-05-01 12:02:31'),(303,10,'eshop_admin_product_images_form_imp',379,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\eshop','D:/work/www\\\\phpapps_dev\\\\eshop',1,1,31,0,'',0,1,1,'2020-05-09 09:01:01','2020-05-01 12:17:27'),(306,27,'cc',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-05-02 18:27:10'),(309,27,'test_app_test3_form_imp',380,'stitle','slabel','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',0,1,1,'2020-05-09 09:01:01','2020-05-02 20:15:39'),(315,14,'test_script',0,'stitle','slabel',NULL,NULL,2,1,1,0,'',0,1,1,'2020-05-09 07:30:42','2020-05-05 19:09:08'),(335,1,'test_11',2,'s_title','s_label','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',NULL,1,1,'2020-05-09 10:04:33','2020-05-09 10:04:33'),(337,1,'test_22',3,'s_title','s_label','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',NULL,1,1,'2020-05-09 19:45:55','2020-05-09 19:45:55'),(338,21,'phpapps_designer_custom_forms_form',360,'Custom forms edit form','Custom form','D:/work/www\\\\phpapps_dev\\\\phpapps','D:/work/www\\\\phpapps_dev\\\\phpapps',1,1,1,0,'',NULL,1,1,'2020-05-10 08:31:32','2020-05-10 08:31:32');
...
INSERT INTO `test2` VALUES (14,'1'),(16,'1'),(18,'1'),(19,'1');
...
INSERT INTO `test3` VALUES (3,'11',222),(4,'11',33),(6,'aaa',777);
...
/*!50001 CREATE TABLE `view_forms` (
  ...
  `SCRIPT_TITLE` tinyint NOT NULL,
  `SCRIPT_LABEL` tinyint NOT NULL,
  `MODULE_ID` tinyint NOT NULL,
  `MODULE_NAME` tinyint NOT NULL,
  `MODULE_TITLE` tinyint NOT NULL,
  `MODULE_LABEL` tinyint NOT NULL,
  `APP_ID` tinyint NOT NULL,
  `APP_NAME` tinyint NOT NULL,
  `APP_TITLE` tinyint NOT NULL,
  `APP_LABEL` tinyint NOT NULL,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_forms` AS select `f`.`ID` AS `ID`,`f`.`SCRIPT_NAME` AS `FORM_NAME`,`f`.`SCRIPT_TITLE` AS `SCRIPT_TITLE`,`f`.`SCRIPT_LABEL` AS `SCRIPT_LABEL`,`f`.`MODULE_ID` AS `MODULE_ID`,`m`.`MODULE_NAME` AS `MODULE_NAME`,`m`.`MODULE_TITLE` AS `MODULE_TITLE`,`m`.`MODULE_LABEL` AS `MODULE_LABEL`,`m`.`APP_ID` AS `APP_ID`,`a`.`APP_NAME` AS `APP_NAME`,`a`.`APP_TITLE` AS `APP_TITLE`,`a`.`APP_LABEL` AS `APP_LABEL`,`f`.`TABLE_ID` AS `TABLE_ID`,`t`.`TABLE_NAME` AS `TABLE_NAME`,`d`.`VALUE` AS `TABLE_SCHEMA`,`f`.`FORM_PHP_DIR` AS `FORM_PHP_DIR`,`f`.`FORM_TPL_DIR` AS `FORM_TPL_DIR`,`f`.`DESCRIPTION` AS `DESCRIPTION`,`f`.`VERSION` AS `VERSION` from ((((`scripts` `f` join `modules` `m`) join `applications` `a`) join `tables` `t`) join `list_databases` `d`) where `f`.`MODULE_ID` = `m`.`ID` and `m`.`APP_ID` = `a`.`ID` and `f`.`TABLE_ID` = `t`.`ID` and `t`.`SCHEMA_ID` = `d`.`ID` and `f`.`WEB_TYPE_ID` = '1' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_scripts` AS select `s`.`ID` AS `ID`,`s`.`SCRIPT_NAME` AS `SCRIPT_NAME`,`s`.`SCRIPT_TITLE` AS `SCRIPT_TITLE`,`s`.`SCRIPT_LABEL` AS `SCRIPT_LABEL`,`a`.`ID` AS `APP_ID`,`a`.`APP_NAME` AS `APP_NAME`,`a`.`APP_TITLE` AS `APP_TITLE`,`a`.`APP_LABEL` AS `APP_LABEL`,`s`.`SCRIPT_TYPE_ID` AS `SCRIPT_TYPE_ID`,`s`.`DESCRIPTION` AS `DESCRIPTION`,`m`.`ID` AS `MODULE_ID`,`m`.`MODULE_NAME` AS `MODULE_NAME`,`m`.`MODULE_TITLE` AS `MODULE_TITLE`,`m`.`MODULE_LABEL` AS `MODULE_LABEL`,concat(`s`.`SCRIPT_NAME`,'.php') AS `FILE_NAME`,concat('phpapps_dev/',`a`.`APP_NAME`,'/',`s`.`SCRIPT_NAME`,'.php') AS `RUN_PATH`,`l`.`ID` AS `LAYOUT_ID`,`l`.`NAME` AS `LAYOUT_NAME`,`s`.`VERSION` AS `VERSION` from (((`scripts` `s` join `modules` `m`) join `applications` `a`) left join `layouts` `l` on(`s`.`LAYOUT_ID` = `l`.`ID`)) where `s`.`MODULE_ID` = `m`.`ID` and `m`.`APP_ID` = `a`.`ID` and `s`.`WEB_TYPE_ID` = '2' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-06-03  0:32:12
