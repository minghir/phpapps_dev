...
include ("generated_php/test_11_generated.php");
	class test_11  extends test_11_generated{
                    /**
                     ...
                     * @var string
                     */
                    protected $_SCRIPT_NAME = "test_11";
		...
		function __construct(){
			parent::__construct();
                        ...
                        $this->tpl = "test_11.tpl";
                        $this->display_objects_id = $this->script_id;
                        
                        $this->load_elements(); // parent function: class template
                        $this->init(); // parent function: class test_11 
			$this->display();// parent function: class test_11 
