...
function submitDetailsForm(op){
		$("#pact").val(op);
		$("#phpapps_database_list_empty_form").submit();
}
  </script>
{/literal}
{$error_msg}
<hr><form name="phpapps_database_list_empty_form" id="phpapps_database_list_empty_form" method="POST" enctype="multipart/form-data">
