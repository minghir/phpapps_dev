...
function submitDetailsForm(op){
		$("#pact").val(op);
		$("#phpapps_database_columns_fks_DDL_form").submit();
}
  </script>
{/literal}
{$error_msg}
<hr><form name="phpapps_database_columns_fks_DDL_form" id="phpapps_database_columns_fks_DDL_form" method="POST" enctype="multipart/form-data">
	...
	<table border="1">
			...
			{$FK_TABLE_ID_sel}
				...
				<tr><td align="right">FK_COLUMN_ID  :</td><td>
			{$FK_COLUMN_ID_sel}
		</td></tr>
