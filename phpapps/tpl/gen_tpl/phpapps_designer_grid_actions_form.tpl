...
{$error_msg}
<hr><form name="phpapps_designer_grid_actions_form" id="phpapps_designer_grid_actions_form" method="POST" enctype="multipart/form-data">
	...
	<table border="1">
				...
				<tr><td align="right">ACTION_SCRIPT :</td><td> <input type="text" id="ACTION_SCRIPT" name="ACTION_SCRIPT" value="{$ACTION_SCRIPT}"></td></tr>
				...
				<tr><td align="right">POPUP_PAGE  :</td><td>
			{$POPUP_PAGE_sel}
		</td></tr>
